                ...
                <div className="relative aspect-[16/9] w-full overflow-hidden bg-[#0a0a14] mt-12">
                  ...
                  <div className="absolute inset-0 flex items-start justify-center pt-8 sm:pt-10 lg:pt-12">
                    <div className="mx-6 sm:mx-8 lg:mx-10 max-w-[80%] text-center space-y-1.5">
                      ...
                      <p className="font-serif text-[19px] sm:text-[24px] lg:text-[29px] font-medium leading-tight text-white [text-shadow:0_2px_8px_rgba(0,0,0,0.6)]">
                        You are about to find
                      </p>
                      <p className="font-serif italic text-[24px] sm:text-[29px] lg:text-[36px] font-medium leading-tight text-amber-400 mt-[4.5rem] sm:mt-[5rem] [text-shadow:0_2px_8px_rgba(0,0,0,0.6)] [filter:drop-shadow(0_1px_2px_rgba(196,168,90,0.25))]">
                        your purpose
                      </p>
                    </div>
                  </div>
