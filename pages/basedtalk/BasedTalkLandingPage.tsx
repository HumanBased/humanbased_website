  ...
  return (
    <BasedTalkLayout>
      ...
      <section className="py-20 text-center">
        <h1 className="font-playfair text-4xl sm:text-5xl lg:text-7xl font-bold mb-8 leading-tight max-w-4xl mx-auto">
          Your reality anchor in confusing conversations.
        </h1>
        <p className="text-lg sm:text-xl lg:text-2xl text-[#102A43]/70 mb-12 max-w-3xl mx-auto font-light leading-relaxed">
      ...
      <section className="py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="basedtalk-glass p-8 lg:p-10 rounded-[2.5rem] shadow-xl hover:shadow-2xl transition-all duration-300">
