...
const SocialHub: React.FC<SocialHubProps> = ({ size = 'full' }) => {
  ...
  const platforms = [
    { 
      name: "LinkedIn",
      url: "https://www.linkedin.com/company/humanbased/",
      icon: (
    ...
    { 
      name: "TikTok",
      url: "https://www.tiktok.com/@HumanBased.org",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    { 
      name: "Facebook",
      url: "https://www.facebook.com/Humanbased",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    { 
      name: "Instagram",
      url: "https://www.instagram.com/HumanBased_official",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    { 
      name: "X",
      url: "https://x.com/HumanBased_org",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  const wheelContent = (
    <Reveal>
      <div className={`relative ${containerSize} aspect-square flex items-center justify-center z-50`}>
